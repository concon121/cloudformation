...
function testIsValid() {
  ...
  #https://cbscl-s3-cloudformation-538162597997.s3-eu-west-2.amazonaws.com/origin-access-identity.yml
  #https://cbscl-s3-cloudformation-538162597997.s3-eu-west-2.amazonaws.com/origin-access-identity.yml
  echo  "https://${CLOUDFORMATION_BUCKET}.s3-eu-west-2.amazonaws.com/${NAME}.yml"
  #aws cloudformation validate-template --template-url "https://${CLOUDFORMATION_BUCKET}.s3-eu-west-2.amazonaws.com/${NAME}.yml" 1> /dev/null
...
then
  ...
  --template-url "https://${CLOUDFORMATION_BUCKET}.s3-eu-west-2.amazonaws.com/${NAME}.yml" \
  --stack-name ${NAME} \
